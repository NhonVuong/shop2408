        ...
        <div class="row">
          <div class="col-xs-12 col-sm-9">
            <div class="entry-detail">
              ...
              <div class="entry-meta-data"> <span class="author"> <i class="fa fa-user"></i>&nbsp; by: <a href="#">Admin</a></span>
                <span class="cat"> <i class="fa fa-folder"></i>&nbsp; <a href="#">News, </a> <a href="#">Promotions</a>
                </span> <span class="comment-count"> <i class="fa fa-comment"></i>&nbsp; 3 </span> <span class="date"><i
                    class="fa fa-calendar">&nbsp;</i>&nbsp; 2015-08-05</span>
              ...
              <div class="content-text clearfix">
                ...
                <p>Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla. Donec porta diam eu massa.
                  Quisque diam lorem, interdum vitae,dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat
                  lacinia fermentum. Donec in velit vel ipsum auctor pulvinar. Vestibulum iaculis lacinia est. Proin
                  dictum elementum velit. Fusce euismod consequat ante. Lorem ipsum dolor sit amet, consectetuer
                  adipiscing elit. Pellentesque sed dolor. Aliquam congue fermentum nisl. </p>
                <p>Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus.
                  Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam
                  cursus leo vel metus. Nulla facilisi. Aenean nec eros.</p>
                <p>Integer rutrum ante eu lacus.Vestibulum libero nisl, porta vel, scelerisque eget, <a href="#">malesuada
                    at</a>, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros.
              ...
              <div class="entry-tags"> <span>Tags:</span> <a href="#">beauty,</a> <a href="#">medicine,</a> <a href="#">health</a>
              </div>
            </div>
            <!-- Related Posts -->
                ...
                <div id="related-posts" class="product-flexslider hidden-buttons">
                  <div class="slider-items slider-width-col4 fadeInUp">
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img2.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          ...
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              1 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2015-12-05 </span>
                          </div>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img3.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          <h3 class="entry-title"><a href="#">Perspiciatis unde omnis</a></h3>
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              5 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2015-12-15 </span>
                          </div>
                          <div class="entry-more"> <a href="#">Read more</a> </div>
                        </div>
                      </article>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img4.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          <h3 class="entry-title"><a href="#">Lorem ipsum dolor</a></h3>
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              6 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2015-12-11 </span>
                          </div>
                          <div class="entry-more"> <a href="#">Read more</a> </div>
                        </div>
                      </article>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img5.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img6.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          <h3 class="entry-title"><a href="#">Iste natus error</a></h3>
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              0 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2015-12-25 </span>
                          </div>
                          <div class="entry-more"> <a href="#">Read more</a> </div>
                        </div>
                      </article>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img7.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          <h3 class="entry-title"><a href="#">omnis iste natus</a></h3>
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              8 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2016-01-09 </span>
                          </div>
                          <div class="entry-more"> <a href="#">Read more</a> </div>
                        </div>
                      </article>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img1.jpg" alt="Blog">
                          </a> </div>
                        <div class="entry-info">
                          <h3 class="entry-title"><a href="#">unde omnis iste</a></h3>
                          <div class="entry-meta-data"> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i>
                              2 </span> <span class="date"> <i class="fa fa-calendar">&nbsp;</i> 2016-01-02 </span>
                          </div>
                          <div class="entry-more"> <a href="#">Read more</a> </div>
                        </div>
                      </article>
                ...
                <ul>
                  <li>
                    ...
                    <div class="comment-body">
                      <div class="comment-meta"> <span class="author"><a href="#">Admin</a></span> <span class="date">2015-04-01</span>
                      </div>
                      ...
                      <li>
                        ...
                        <div class="comment-body">
                          ...
                          <div class="comment"> Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis.
                            Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget,
                            malesuada at, neque. </div>
                        </div>
                      </li>
                      <li>
                        <div class="avartar"> <img src="public/source/images/avatar.png" alt="Avatar"> </div>
                    ...
                    <ul class="blog-list-sidebar">
                      <li>
                        ...
                        <div class="post-info">
                          ...
                          <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span>
                            <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 8 </span> </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="post-info">
                          <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                          <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span>
                            <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 5 </span> </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="post-info">
                          <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                          <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span>
                            <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 1 </span> </div>
                        </div>
                      </li>
                    </ul>
                  </div>
